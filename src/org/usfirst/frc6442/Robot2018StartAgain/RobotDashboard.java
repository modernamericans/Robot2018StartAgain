...
public class RobotDashboard {
	...
	public static void initDashboard() {
    	...
    	SmartDashboard.putData("DriveForwardFullTime(.2)", new DriveForwardFullTime(.2));
    	SmartDashboard.putData("DriveForwardFullTime(.4)", new DriveForwardFullTime(.4));
    	SmartDashboard.putData("DriveForwardFullTime(.6)", new DriveForwardFullTime(.6));
    	SmartDashboard.putData("DriveForwardFullTime(.8)", new DriveForwardFullTime(.8));
    	SmartDashboard.putData("DriveForwardFullTime(1)", new DriveForwardFullTime(1.0));
    	SmartDashboard.putData("DriveForwardFullTime(2)", new DriveForwardFullTime(2.0));
    	SmartDashboard.putData("DriveForwardFullTime(3)", new DriveForwardFullTime(3.0));
